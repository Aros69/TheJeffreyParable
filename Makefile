...
Survive-Linux-Debug:
	 $(PROJECTBUILD) Survive Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Survive-Linux-DebugGame:
	 $(PROJECTBUILD) Survive Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Survive-Linux-Shipping:
	 $(PROJECTBUILD) Survive Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Survive-Linux-Test:
	 $(PROJECTBUILD) Survive Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Survive:
	 $(PROJECTBUILD) Survive Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

SurviveEditor-Linux-Debug:
	 $(PROJECTBUILD) SurviveEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SurviveEditor-Linux-DebugGame:
	 $(PROJECTBUILD) SurviveEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SurviveEditor-Linux-Shipping:
	 $(PROJECTBUILD) SurviveEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SurviveEditor-Linux-Test:
	 $(PROJECTBUILD) SurviveEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SurviveEditor:
	 $(PROJECTBUILD) SurviveEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
