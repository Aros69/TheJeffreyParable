...
unrealRootPath=/home/robin/.UnrealEngine4
SurviveRootPath=/home/robin/Dev/Unreal/mcgamejam2018Final 4.19

gameProjectFile=/home/robin/Dev/Unreal/mcgamejam2018Final 4.19/Survive.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(SurviveSource.pri)
include(SurviveHeader.pri)
include(SurviveConfig.pri)
include(SurviveIncludes.pri)
include(SurviveDefines.pri)
...
Survive-Linux-Debug.commands = $$build Survive Linux Debug  -project="\"$$gameProjectFile\"" $$args
Survive-Linux-DebugGame.commands = $$build Survive Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Survive-Linux-Shipping.commands = $$build Survive Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Survive-Linux-Test.commands = $$build Survive Linux Test  -project="\"$$gameProjectFile\"" $$args
Survive.commands = $$build Survive Linux Development  -project="\"$$gameProjectFile\"" $$args

SurviveEditor-Linux-Debug.commands = $$build SurviveEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
SurviveEditor-Linux-DebugGame.commands = $$build SurviveEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
SurviveEditor-Linux-Shipping.commands = $$build SurviveEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
SurviveEditor-Linux-Test.commands = $$build SurviveEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
SurviveEditor.commands = $$build SurviveEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	Survive-Linux-Debug \
	Survive-Linux-DebugGame \
	Survive-Linux-Shipping \
	Survive-Linux-Test \
	Survive \
	SurviveEditor-Linux-Debug \
	SurviveEditor-Linux-DebugGame \
	SurviveEditor-Linux-Shipping \
	SurviveEditor-Linux-Test \
	SurviveEditor \
